...
if(GNULIKE)
    set(OPT_FLAGS "${OPT_FLAGS} -ffunction-sections -fdata-sections")
    if(CLANG)
        if(WIN32)
            set(LINK_OPT_FLAGS "${LINK_OPT_FLAGS} -Wl,/OPT:REF")
        else()
            set(LINK_OPT_FLAGS "${LINK_OPT_FLAGS} -Wl,-dead_strip")
        endif()
    else()
        set(LINK_OPT_FLAGS "${LINK_OPT_FLAGS} -Wl,--gc-sections")
    endif()
endif()
...
set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS_RELEASE} ${LINK_OPT_FLAGS}")
set(CMAKE_SHARED_LINKER_FLAGS_RELWITHDEBINFO "${CMAKE_SHARED_LINKER_FLAGS_RELWITHDEBINFO} ${LINK_OPT_FLAGS}")
